...
public class FirstTest {
    ...
    public void testAmountOfNotEmptySearch(){
        ...
        Assert.assertTrue(
                "We found too few results: " + amount_of_search_results,
    ...
    public void testAmountOfEmptySearch() {
        ...
        String search_line = "dfhgfhfghfghfghfgh";
    ...
    public void saveTwoArticles () {
        ...
        waitForElementPresent(
                By.id("org.wikipedia:id/view_page_title_text"),
                "Cannot find the second article title",
                15
        );

        String the_second_article_title_before_saving = waitForElementAndGetAttribute(
                By.id("org.wikipedia:id/view_page_title_text"),
                "Cannot find the second article title",
                5
        );
        ...
        waitForElementAndClick(
                By.xpath("//*[@text='" + name_of_folder + "']"),
                "Cannot find folder in the list " + name_of_folder,
                5
        );
        ...
        waitForElementPresent(
                ...
                "Cannot find the second article after deleting the first",
                5
        );
        ...
        String the_second_article_title_after_saving = waitForElementAndGetAttribute(
                By.id("org.wikipedia:id/view_page_title_text"),
                "Cannot find the second article title",
                5
        );
    ...
    private boolean waitForElementNotPresent(By by, String error_meassage, long timeoutInSeconds) {
        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
        wait.withMessage(error_meassage + "\n");
        return wait.until(
    ...
    private WebElement assertElementHasText (By by, String expected_text, String error_message){
         WebElement element = waitForElementPresent(by, "Cannot find element for text comparing");
